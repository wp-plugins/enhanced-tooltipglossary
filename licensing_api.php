<?php
if( !class_exists('CMTT_Cminds_Licensing_API') )
{

    class CMTT_Cminds_Licensing_API
    {
...
//            add_action('update_option_' . $this->optionLicenseKey, array($this, 'after_new_license_key'), 10, 2);
        ...
        {
            if( has_action('cminds-tooltip-license-page') )
            {
        ...
        public function license_page()
        {
             ...
             */
            do_action('cminds-tooltip-license-page');
        ...
        {
            if( has_action('cminds-tooltip-update-page') )
            {
        ...
        public function update_page()
        {
             ...
             * Call the action in the add-ons
             */
            do_action('cminds-tooltip-update-page');
