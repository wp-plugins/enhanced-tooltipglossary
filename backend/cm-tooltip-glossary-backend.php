...
class CMTooltipGlossaryBackend
{
    ...
    public static function cmtt_admin_menu()
    {
        ...
        add_submenu_page(CMTT_MENU_OPTION, 'Pro Versions', 'Pro Versions', 'edit_posts', CMTT_PRO_OPTION, array(self::$calledClassName, 'cmtt_admin_pro'));

        if( user_can($current_user, 'edit_posts') )
        {
            $submenu[CMTT_MENU_OPTION][500] = array('User Guide', 'edit_posts', 'https://tooltip.cminds.com/cm-tooltip-user-guide/');
        }
