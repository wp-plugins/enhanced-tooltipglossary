...
class CMTooltipGlossary
{
    ...
    public function __construct()
    {
        ...
        $licensingApi = new CMTT_Cminds_Licensing_API('CM Tooltip Glossary', CMTT_MENU_OPTION, CMTT_NAME, CMTT_PLUGIN_FILE, array('release-notes' => 'https://tooltip.cminds.com/release-notes/'));
